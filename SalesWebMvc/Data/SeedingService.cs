...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s2 = new Seller(2, "Jane Doe", "jane@gmail.com", new DateTime(1994, 2, 4), 1000.0, d1);
            Seller s3 = new Seller(3, "Mario Gad", "mario@gmail.com", new DateTime(1995, 6, 13), 1000.0, d2);
            Seller s4 = new Seller(4, "Richard Schmitz", "richard@gmail.com", new DateTime(1984, 1, 20), 1000.0, d2);
            Seller s5 = new Seller(5, "Vanessa Twain", "vanessa@gmail.com", new DateTime(1989, 12, 5), 1000.0, d3);
            Seller s6 = new Seller(7, "Johanna Hideo", "johanna@gmail.com", new DateTime(1992, 3, 5), 1000.0, d4);
